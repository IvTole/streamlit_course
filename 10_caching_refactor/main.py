...
# Comparison between dates consistency
@st.cache_data
...
if __name__ == "__main__":
    ...
    # Time start, end, in different formats (str and datetime)
    ...
    try:
        ...
        st.exception(e)
    if end_before_start(ts_start,ts_end):
